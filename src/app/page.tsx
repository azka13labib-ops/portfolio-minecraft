    ...
    <main className="relative bg-black w-full min-h-screen">
      ...
      >
        ...
        <div id="hero-wrapper" className="absolute inset-0 w-full h-screen z-10">
          {/* Navigation (Now absolute within Hero) */}
          <Navbar />

          {/* Absolute Right-Side Social Sidebar (Only in Hero) */}
          <div className="absolute right-6 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-6 bg-[#0E0E0E]/80 border border-neutral-800/80 rounded-full p-4 shadow-[0_0_20px_rgba(0,0,0,0.5)] backdrop-blur-md pointer-events-auto">
            {[
              {
