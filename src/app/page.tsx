...
export default function Home() {
  ...
  return (
    <main className="relative bg-black w-full min-h-screen">
      ...
      {/* Fixed Right-Side Social Sidebar */}
      <div className="fixed right-6 top-1/2 -translate-y-1/2 z-100 flex flex-col gap-6 bg-[#0E0E0E]/80 border border-neutral-800/80 rounded-full p-4 shadow-[0_0_20px_rgba(0,0,0,0.5)] backdrop-blur-md">
        {[
          {
          ...
          {
            href: "mailto:azkalabib@example.com",
