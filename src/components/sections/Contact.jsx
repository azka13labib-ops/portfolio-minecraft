    ...
    >
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col items-start text-left">
          <h2 className="contact-content text-5xl md:text-7xl font-black mb-6 text-transparent bg-clip-text bg-linear-to-r from-[#FB64B6] to-[#7000FF] font-orbitron tracking-tight">
            Let&apos;s Talk!
          </h2>
        ...
        <div className="contact-content relative w-full bg-[#111] p-8 md:p-10 rounded-3xl border border-neutral-800 shadow-2xl">
          {/* Glassmorphism subtle glow */}
          <div className="absolute -inset-1 bg-linear-to-r from-[#FB64B6] to-[#7000FF] rounded-4xl blur-xl opacity-20 pointer-events-none"></div>
          ...
          >
            <div className="flex flex-col gap-2">
              <label htmlFor="name" className="text-sm font-mono text-neutral-400 uppercase tracking-wider">Nama Anda</label>
              <input 
                type="text" 
                id="name"
                name="name"
                ...
                className="w-full bg-[#1A1A1A] border border-neutral-800 rounded-xl px-5 py-4 text-white placeholder-neutral-600 focus:outline-none focus:border-[#FB64B6] focus:ring-1 focus:ring-[#FB64B6] transition-all"
              />
            </div>
            
            <div className="flex flex-col gap-2">
              <label htmlFor="email" className="text-sm font-mono text-neutral-400 uppercase tracking-wider">Alamat Email</label>
              <input 
                type="email" 
                id="email"
                name="email"
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="message" className="text-sm font-mono text-neutral-400 uppercase tracking-wider">Pesan</label>
              <textarea 
                id="message"
                name="message"
                required
                ...
                className="w-full bg-[#1A1A1A] border border-neutral-800 rounded-xl px-5 py-4 text-white placeholder-neutral-600 focus:outline-none focus:border-[#FB64B6] focus:ring-1 focus:ring-[#FB64B6] transition-all resize-none"
              ></textarea>
            </div>

            <button 
              type="submit"
              className="mt-4 w-full relative inline-flex items-center justify-center px-8 py-5 text-lg font-bold text-white transition-all duration-300 bg-transparent border-2 border-[#FB64B6] rounded-xl hover:bg-[#FB64B6] hover:text-white focus:outline-none overflow-hidden group"
            >
